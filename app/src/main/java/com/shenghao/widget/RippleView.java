...
public class RippleView extends RelativeLayout {
    ...
    //涟漪的颜色
    private int rippleColor = Color.parseColor("#1A1D99FF");
    //最里面涟漪的实心圆
    ...
    //每次动画的时间
    private int rippleDurationTime = 3200;
    //涟漪条目
    ...
    private void init() {
        ...
        rippleParams.addRule(CENTER_HORIZONTAL|ALIGN_PARENT_TOP, TRUE);
        rippleParams.setMargins(0, DensityUtil.dip2px(getContext(),73),0,0);//计算ripple距离顶部距离73dp
