...
//            position = divided + offset + 1;
        ...
        for (int i = 0; i < childSize; i++) {
            ...
            if (position == i) {
                itemView.setTextColor(Color.parseColor("#E6000000"));
            } else {
                itemView.setTextColor(Color.parseColor("#66000000"));
            }
        }
    }
    ...
    public void setBackgroundDrawable(Drawable background) {
        ...
        if (viewWidth == 0) {
//            viewWidth = ((AppCompatActivity) context).getWindowManager().getDefaultDisplay().getWidth();
