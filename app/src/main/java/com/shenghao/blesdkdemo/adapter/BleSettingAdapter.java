...
public class BleSettingAdapter extends RecyclerView.Adapter<BleSettingAdapter.AlarmHolder> {
    private Context context;
    private List<AlarmSettingBean> alarmList;
    private onSwitchCheckedListener onSwitchCheckedListener;

    public BleSettingAdapter(Context context, List<AlarmSettingBean> alarmList, onSwitchCheckedListener onSwitchCheckedListener) {
