...
import com.shenghao.ui.BleActivity;
...
public class BleAdapter extends RecyclerView.Adapter<BleAdapter.BleHolder> {
    ...
    public BleAdapter(Context context, List<BleDevice> mList) {
...
//        }
    ...
    private int getIndexOf(String deviceAddress) {
        for (int i = 0; i < mList.size(); i++) {
            BleDevice bleDevice = mList.get(i);
    ...
    public static boolean isContains(List<BleDevice> allConnectedDevice, BleDevice bleDevice) {
