...
//import com.shenghao.blesdkdemo.adapter.CarInfoAdapter;
//import com.shenghao.blesdkdemo.adapter.ExamplePagerAdapter;
//import com.shenghao.blesdkdemo.adapter.GridSpacingItemDecoration;
//import com.shenghao.blesdkdemo.bean.ControlInfo;
//import com.shenghao.blesdkdemo.bean.ControlInfoResp;
...
//import com.shenghao.blesdkdemo.widget.ClipPagerTitleView;
//import com.shenghao.blesdkdemo.widget.ModeDialog;
//
...
//        View view = LayoutInflater.from(getContext()).inflate(R.layout.activity_control, null);
//        initViews(view);
//        return view;
//    }
//
...
//        rgVoltage = view.findViewById(R.id.rgVoltage);
//        rgStartWay = view.findViewById(R.id.rgStartWay);
//        rgDao = view.findViewById(R.id.rgDao);
//        rgFangLiu = view.findViewById(R.id.rgFangLiu);
//        rgDou = view.findViewById(R.id.rgDou);
//        rgForward = view.findViewById(R.id.rgForward);
//        rgBack = view.findViewById(R.id.rgBack);
//        rgTurn = view.findViewById(R.id.rgTurn);
//        rgPower = view.findViewById(R.id.rgPower);
//
//        switchP = view.findViewById(R.id.switchP);
//        switchEBS = view.findViewById(R.id.switchEBS);
//        switchXun = view.findViewById(R.id.switchXun);
//        switchXian = view.findViewById(R.id.switchXian);
//        tvP = view.findViewById(R.id.tvP);
//        tvEBS = view.findViewById(R.id.tvEBS);
//        tvXun = view.findViewById(R.id.tvXun);
//        tvXian = view.findViewById(R.id.tvXian);
//        recyclerView = view.findViewById(R.id.recyclerView);
//        mViewPager = view.findViewById(R.id.view_pager);
//        mViewPager.setAdapter(mExamplePagerAdapter);
//        view.findViewById(R.id.tvRecover).setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View v) {
//                setCarControl("0"+visibleIndex,"0");
//            }
//        });
//        view.findViewById(R.id.tvMode).setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View v) {
//                new ModeDialog(requireActivity(), new ModeDialog.OnCloseListener() {
//                    @Override
...
//        recyclerView.addItemDecoration(new GridSpacingItemDecoration(2, DensityUtil.dip2px(requireActivity(),16), false));
//        for (String s : InfoTitle) {
//            dataList.add(new CarInfoAdapter.CarInfo(s, 1));
//        }
//        adapter = new CarInfoAdapter(requireActivity(),dataList); // dataList 是你的数据源
...
//        super.onResume();
////        ToastUtils.showShort(requireActivity(),"onResume");
//        getCarControlInfo();
//    }
//
...
//                clipPagerTitleView.setTextSize(DensityUtil.sp2px(requireActivity(),12));
...
//                }else {
//                    updateUI(controlInfoResp.getData());
//                    ToastUtils.showShort(requireActivity(), TextUtils.isEmpty(controlInfoResp.getMsg())? getString(R.string.request_retry):controlInfoResp.getMsg());
//                }
//            }
//
//            @Override
...
//                if(isChecked){
//                    tvP.setText("开");
//                    tvP.setTextColor(Color.parseColor("#17cbbc"));
//                }else {
//                    tvP.setText("关");
...
//                if(isChecked){
//                    tvEBS.setText("开");
//                    tvEBS.setTextColor(Color.parseColor("#17cbbc"));
//                }else {
//                    tvEBS.setText("关");
...
//                if(isChecked){
//                    tvXun.setText("开");
//                    tvXun.setTextColor(Color.parseColor("#17cbbc"));
//                }else {
//                    tvXun.setText("关");
...
//                if(isChecked){
//                    tvXian.setText("开");
//                    tvXian.setTextColor(Color.parseColor("#17cbbc"));
//                }else {
//                    tvXian.setText("关");
...
//        if(isChecked){
//            tv.setText("开");
//            tv.setTextColor(Color.parseColor("#17cbbc"));
//        }else {
//            tv.setText("关");
